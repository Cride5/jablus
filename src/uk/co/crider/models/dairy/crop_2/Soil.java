...
public class Soil {
	...
	final float EFFN = 0.5f; // TODO!        fertilization efficiency                                           sans dimension
...
//System.out.println(Utils.arrayString(HUMIN));
	...
	public void sewCrop(Crop crop){
		...
		if(crop instanceof Pasture){
			...
			depositResidue(crop.getMASEC() * Pasture.GRASS_RES_CARBON * 1000); // Conversion to t/ha
		}
	...
	public void execDay(
			...
			double ANIT,       // fertilization table                                            kg N lia-l day-l
...
//System.out.println("ZRAC_:" + ZRAC_ + " CUMLRACZ_:" + CUMLRACZ_);
		if(ZRAC > 0 && CUMLRACZ > 0){
			...
			double TETSTOMATE = (1 / 40) * Math.log((EOP / (2 * Math.PI * CUMLRACZ * PSISTO * 10))
...
//System.out.println("SWFAC:" + SWFAC + " EOP:" + EOP + " EP:" + EP);
			...
			double TETURG = (1 / 40) * Math.log((EOP / (2 * Math.PI * CUMLRACZ * PSITURG * 10))
										* Math.log(Math.sqrt(Math.PI * CUMLRACZ / ZRAC) / RAYON));
...
//			if(DEBUG) System.out.println("Day: " + I + " \tYield: " + Utils.roundString(MAGRAIN / 100) + " t/ha\tLeaching: " + Utils.roundString(QLES) + " kgN/ha/day" + "\n");
	...
	// Visualise state of module
	public void printState(){
		System.out.println("Leaching (kgN/ha/day): " + Utils.roundString(QLES) + "\tWater Stress: " + Utils.roundString((SWFAC + TURFAC)/2) + "\tN Stress: " + INNS);		
	}
	private double [] LRAC;
